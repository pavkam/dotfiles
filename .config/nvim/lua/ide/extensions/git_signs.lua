...
function GitSigns:on_register(ctx)
    ...
    ctx:keymap('n', ']h', function() ext:next_hunk() end, { desc = 'Next git hunk' })
    ctx:keymap('n', '[h', function() ext:prev_hunk() end, { desc = 'Prev git hunk' })
    ctx:keymap('n', 'ghr', function() ext:reset_hunk() end, { desc = 'Reset hunk' })
    ctx:keymap('n', 'ghh', function() ext:preview_hunk_inline() end, { desc = 'Preview hunk' })
    ctx:keymap('n', 'ghs', function() ext:stage_hunk() end, { desc = 'Stage hunk' })
    ctx:keymap('n', 'ghu', function() ext:undo_stage_hunk() end, { desc = 'Undo stage hunk' })
    ctx:keymap('n', 'ghb', function() ext:blame_line() end, { desc = 'Blame line' })
    ctx:keymap('n', 'ghx', function() ext:select_hunk() end, { desc = 'Select hunk' })
    ctx:keymap('n', 'ghS', function() ext:stage_buffer() end, { desc = 'Stage buffer' })
    ctx:keymap('n', 'ghR', function() ext:reset_buffer() end, { desc = 'Reset buffer' })

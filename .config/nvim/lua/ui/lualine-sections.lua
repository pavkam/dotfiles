...
local components = {
    ...
    file_name = {
        ...
        fmt = function(name)
            ...
            return vim.fs.format_relative_path(root, vim.api.nvim_buf_get_name(0), { include_base_dir = true })
        end,
        on_click = function()
            vim.cmd 'Debug'
        end,
    ...
    'mason',
    {
        ...
        winbar = {
            lualine_b = {
                ...
                {
                    function()
                        local _, type = require('ui.qf').details()
            ...
            lualine_c = {
                function()
                    local details = require('ui.qf').details()
